    ...
    <div className="bg-background-light dark:bg-background-dark min-h-screen font-sans">
      ...
      <header className="py-12 text-center">
        ...
        <p className="mt-4 text-primary/70 dark:text-gold/70 font-display italic text-lg max-w-xl mx-auto px-4">
          Moments that define our journey — celebrations, achievements, and everyday campus life.
        </p>
      </header>

      {/* ── Category Tabs ──────────────────────────────────────────────────── */}
      <div className="max-w-7xl mx-auto px-4">
        <div className="border-b border-primary/10 dark:border-gold/10 mb-10 overflow-x-auto">
          <div className="flex gap-8 whitespace-nowrap min-w-max">
            {(["all", ...GALLERY_CATEGORIES.filter(c => c !== "all")] as GalleryCategory[]).map(cat => (
              <button
                ...
                className={`pb-4 border-b-2 font-bold text-sm tracking-wider uppercase transition-all capitalize ${
                  activeCategory === cat
